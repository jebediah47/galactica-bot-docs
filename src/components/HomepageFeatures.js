...
const FeatureList = [
  {
    ...
    description: (
      <>
        Galactica is built from the ground up to be easily installed and used to
        get your Discord™ server up and running quickly.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Extend or customize galactica with Discord.js. Galactica can be modified
        while reusing the same command handler and framework
      </>
    ),
  },
];
