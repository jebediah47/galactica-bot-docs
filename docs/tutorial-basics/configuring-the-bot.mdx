...
## Useful info
:::tip info
It is recommended to edit `JSON` files with a text editor I would recommend [`Visual Studio Code`](https://code.visualstudio.com/) which is completely free and open-source. For Linux you can download the binary from the vscode website if available or download your distribution's package accordingly.
:::
